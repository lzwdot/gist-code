...
function prefetch(entry: Entry, opts?: ImportEntryOpts): void {
  ...
  // 在空闲的时间去加载应用
  requestIdleCallback(async () => { // 替代了我们的 system.js，参考：https://github.com/systemjs/systemjs
    // 内部使用 fetch
...
// 监听 等待第一个应用挂载完成 single-spa 中第一次挂载完毕后会触发的事件
...
export function doPrefetchStrategy(
  apps: AppMetadata[],
  prefetchStrategy: PrefetchStrategy, // 默认为 true
